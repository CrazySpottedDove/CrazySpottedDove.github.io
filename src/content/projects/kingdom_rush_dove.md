...
* 红箭：血色审判从秒杀改为高额伤害（对 boss 伤害小幅降低），概率提升，无视护盾。猎人印记可对boss使用，且红箭优先攻击被标记敌人，攻击被标记敌人时触发血色审判概率提升。红箭的普攻和标记箭飞行过程中，如果敌人死亡，将会尝试转火。
...
* 大树：普攻智能索敌。火果子冷却下调，伤害下调。保留普攻减速。优化普攻与技能衔接。捶地分为内圈和外圈，外圈造成原伤害和减速，内圈造成额外40%伤害和晕眩。
...
* 圣殿：受到异常效果时使用圣杯解控（如解除火焰）。攻击提升下一次复活概率。动脉打击触发概率翻倍，且可以使受打击的目标易伤提升3.3%（乘算）。
