...
> 由于无尽后期出怪较多，容易导致游戏卡顿，因此建议您在 60/30 帧下游玩无尽模式。如果发生画面卡死现象，可以尝试利用快捷键 4 减速，并耐心等待画面恢复正常工作，然后退出，保存存档，选择更低帧率进行游玩。
...
* 一些拥有远程攻击能力的英雄，其恢复间隔将高于近战英雄。

一些英雄的机制性调整：

#### 一代英雄

* 小公主：真伤分裂箭允许多余箭矢对单一目标释放，且会预估敌人血量保证箭矢不浪费。使用箭矢速度的动画效果暗示了总伤。召唤猫咪期间为无敌状态。
